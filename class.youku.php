...
class youku{
	public function __construct(){
		...
		**/
		...
		add_action('wp_enqueue_scripts', array($this, 'youku_scripts'));
	}
	...
	public function action_quest(){
		...
		if( $_POST["action"]=="ykv-update-config" ){
			if( isset($_POST["empty-config"]) ){
				...
				$this->update_config(array("pagename" => trim($_POST["pagename"]),"number" => $_POST["number"],"row"=> $_POST["row"],"time" => $_POST["time"],"css" => $_POST["css"],"js" => $_POST["js"],"swf_url" => $_POST["swf_url"]));
